...
export const recentCalls: CallRecord[] = [
  ...
  },
  {
    id: "flt-66210",
    company: "IndiGo",
    problem: "Cancellation refund",
    date: "11 Sep, 2:06 PM",
    status: "Failed",
  },
];

export const callStateCopy: Record<
  CallState,
  { label: string; detail: string; mode: "pulse" | "calm" | "voice" | "listen" }
> = {
  ...
  HUMAN_DETECTED: {
    ...
    detail: "A representative is on the line",
    mode: "listen",
  },
  AI_SPEAKING: { label: "AI SPEAKING", detail: "Saathi is speaking", mode: "voice" },
  USER_SUMMONED: {
    label: "NEEDS YOU",
    detail: "Saathi is bringing you into the call",
    mode: "pulse",
  },
  USER_LISTENING: {
    label: "YOU’RE LISTENING",
    detail: "Saathi is continuing the conversation",
    mode: "listen",
  },
  USER_IN_CONTROL: {
    label: "YOU’RE IN CONTROL",
    detail: "Saathi is listening silently",
    mode: "voice",
  },
  VERIFICATION_REQUIRED: {
    label: "VERIFICATION REQUIRED",
    detail: "An OTP was requested",
    mode: "calm",
  },
  COMPLETED: { label: "CALL COMPLETE", detail: "The call has ended", mode: "calm" },
};

export const simulatedSequence: CallState[] = [
  "DIALING",
  "RINGING",
  "IVR",
  "HOLD",
...
export function parseMandate(value: string) {
  ...
  return {
    valid:
      ...
      !vague &&
      /refund|redeliver|replacement|credit/i.test(lower) &&
      Boolean(amount || /redeliver|replacement/i.test(lower)),
